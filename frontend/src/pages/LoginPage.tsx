...
// SVG'yi veri URI'si olarak buraya ekliyoruz
    ...
    >
      <div style={styles.container}>
        <div style={styles.content}>
          ...
          <Text style={{ color: 'rgba(255, 255, 255, 0.65)', marginTop: 32, display: 'block' }}>
          ...
          <Link to="/register">
              <Button 
                ...
                ghost
                block 
                style={{ marginTop: 8, height: 45, borderRadius: 25, borderColor: 'rgba(255, 255, 255, 0.3)', color: '#fff' }}
              >
                  Kayıt Ol
              </Button>
          </Link>
        ...
        <div style={styles.footer}>
          <Space direction="vertical">
              <Text style={{ color: 'rgba(255, 255, 255, 0.5)' }}>SOSYAL MEDYA BAĞLANTILARI</Text>
